...
public class DefaultUncertaintyCalculator implements UncertaintyCalculator {
    ...
    @Override
    public Result calculate(Prefix prefix, Inputs inputs) {
        ...
        return new Result(prefix, inputs, meanReferencedValue, meanCheckedValue, error, uA, uB, uC, uncertainty, AL, AU, pass);
    }
