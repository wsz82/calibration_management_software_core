...
import spio2023.cms.model.procedure.Setting;
import spio2023.cms.model.procedure.step.DisplayStep;
import spio2023.cms.model.procedure.step.InputStep;
...
public class SampleData_PP_METEX_3610 {
    ...
    public static Procedure procedure() {
        ...
        var settings = new Setting(1, true);
        return new Procedure(settings, multimeter_PP_METEX_3610(), multimeter_INMEL7000(), controlPoints, Arrays.asList(
                ...
                new InputStep("Ustaw na kalibratorze napięcie stałe: 180mV" + repeatingInstruction,
                        dcv, dcvPoints.get(0)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -180mV" + repeatingInstruction,
                        dcv, dcvPoints.get(1)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 20mV" + repeatingInstruction,
                        dcv, dcvPoints.get(2)),
                new DisplayStep("Ustaw zakres 2V napiecia stałego"),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 1,8V" + repeatingInstruction,
                        dcv, dcvPoints.get(3)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -1,8V" + repeatingInstruction,
                        dcv, dcvPoints.get(4)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 0,2V" + repeatingInstruction,
                        dcv, dcvPoints.get(5)),
                new DisplayStep("Ustaw zakres 20V napiecia stałego"),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 18V" + repeatingInstruction,
                        dcv, dcvPoints.get(6)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -18V" + repeatingInstruction,
                        dcv, dcvPoints.get(7)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 10V" + repeatingInstruction,
                        dcv, dcvPoints.get(8)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 2V" + repeatingInstruction,
                        dcv, dcvPoints.get(9)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -2V" + repeatingInstruction,
                        dcv, dcvPoints.get(10)),
                new DisplayStep("Ustaw zakres 200V napiecia stałego"),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 180V" + repeatingInstruction,
                        dcv, dcvPoints.get(11)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -180V" + repeatingInstruction,
                        dcv, dcvPoints.get(12)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 20V" + repeatingInstruction,
                        dcv, dcvPoints.get(13)),
                new DisplayStep("Ustaw zakres 1000V napiecia stałego"),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 900V" + repeatingInstruction,
                        dcv, dcvPoints.get(14)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: -900V" + repeatingInstruction,
                        dcv, dcvPoints.get(15)),
                new InputStep("Ustaw na kalibratorze napięcie stałe: 100V" + repeatingInstruction,
                        dcv, dcvPoints.get(16)),
                new DisplayStep("Ustaw zakres 200mV napiecia zmiennego"),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 180mV@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(0)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 180mV@400Hz" + repeatingInstruction,
                        acv, acvPoints.get(1)),
                new DisplayStep("Ustaw zakres 2V napiecia zmiennego"),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 1,8V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(2)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 1,8V@400Hz" + repeatingInstruction,
                        acv, acvPoints.get(3)),
                new DisplayStep("Ustaw zakres 20V napiecia zmiennego"),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 2V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(4)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 10V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(5)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 18V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(6)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne:18V@400Hz" + repeatingInstruction,
                        acv, acvPoints.get(7)),
                new DisplayStep("Ustaw zakres 200V napiecia zmiennego"),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 180V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(8)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 180V@400Hz" + repeatingInstruction,
                        acv, acvPoints.get(9)),
                new DisplayStep("Ustaw zakres 750V napiecia zmiennego"),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 680V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(10)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 750V@60Hz" + repeatingInstruction,
                        acv, acvPoints.get(11)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 680V@400Hz" + repeatingInstruction,
                        acv, acvPoints.get(12)),
                new InputStep("Ustaw na kalibratorze napięcie zmienne: 750V@400Hz" + repeatingInstruction,
                ...
                new InputStep("Ustaw na kalibratorze prąd stały: 180uA" + repeatingInstruction,
                        dca, dcaPoints.get(0)),
                new DisplayStep("Ustaw zakres 2mA prądu stałego"),
                new InputStep("Ustaw na kalibratorze prąd stały: 1,8mA" + repeatingInstruction,
                        dca, dcaPoints.get(1)),
                new DisplayStep("Ustaw zakres 20mA prądu stałego"),
                new InputStep("Ustaw na kalibratorze prąd stały: 18mA" + repeatingInstruction,
                        dca, dcaPoints.get(2)),
                new DisplayStep("Ustaw zakres 200mA prądu stałego"),
                new InputStep("Ustaw na kalibratorze prąd stały: 180mA" + repeatingInstruction,
                        dca, dcaPoints.get(3)),
                new DisplayStep("Ustaw zakres 2A prądu stałego"),
                new InputStep("Ustaw na kalibratorze prąd stały: 1,8A" + repeatingInstruction,
                        dca, dcaPoints.get(4)),
                new InputStep("Ustaw na kalibratorze prąd stały: 1A" + repeatingInstruction,
                        dca, dcaPoints.get(5)),
                ...
                new InputStep("Ustaw na kalibratorze prąd stały: 18A" + repeatingInstruction,
                        dca, dcaPoints.get(6)),
                new InputStep("Ustaw na kalibratorze prąd stały: 10A" + repeatingInstruction,
                        dca, dcaPoints.get(7)),
                new DisplayStep("Podłącz przewody:  OUTPUT HI ------------>  A; OUTPUT LO ------------>  COM"),
                new DisplayStep("Ustaw zakres 200uA prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 180uA@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(0)),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 180uA@400Hz" + repeatingInstruction,
                        aca, acaPoints.get(1)),
                new DisplayStep("Ustaw zakres 2mA prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 1,8mA@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(2)),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 1,8mA@400Hz" + repeatingInstruction,
                        aca, acaPoints.get(3)),
                new DisplayStep("Ustaw zakres 20mA prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 18mA@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(4)),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 18mA@400Hz" + repeatingInstruction,
                        aca, acaPoints.get(5)),
                new DisplayStep("Ustaw zakres 200mA prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 180mA@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(6)),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 180mA@400Hz" + repeatingInstruction,
                        aca, acaPoints.get(7)),
                new DisplayStep("Ustaw zakres 2A prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 1,8A@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(8)),
                new InputStep("Ustaw na kalibratorze prąd zmienny: 1,8A@400Hz" + repeatingInstruction,
                        aca, acaPoints.get(9)),
                new DisplayStep("Zmień połączenie przewodów: 20A CURRENT OUTPUT HI   ------------>  20A; OUTPUT LO    ------------>  COM"),
                new DisplayStep("Ustaw zakres 20A prądu zmiennego"),
                new InputStep("Ustaw na kalibratorze prąd amienny: 18A@60Hz" + repeatingInstruction,
                        aca, acaPoints.get(10)),
                new InputStep("Ustaw na kalibratorze prąd amienny: 18A@400Hz" + repeatingInstruction,
                ...
                new InputStep("Ustaw na kalibratorze rezytancję: 1Ohm" + repeatingInstruction,
                        res, resPoints.get(0)),
                new InputStep("Ustaw na kalibratorze rezytancję: 190Ohm" + repeatingInstruction,
                        res, resPoints.get(1)),
                new DisplayStep("Ustaw zakres 20 kOhm"),
                new InputStep("Ustaw na kalibratorze rezytancję: 19kOhm" + repeatingInstruction,
                        res, resPoints.get(2)),
                new DisplayStep("Zmień połączenie przewodów: SENSE HI ------------>  Ohm; SENSE LO ------------>  COM"),
                new DisplayStep("Ustaw zakres 200 kOhm"),
                new InputStep("Ustaw na kalibratorze rezytancję: 190kOhm" + repeatingInstruction,
                        res, resPoints.get(3)),
                new DisplayStep("Ustaw zakres 2 MOhm"),
                new InputStep("Ustaw na kalibratorze rezytancję: 1,9MOhm" + repeatingInstruction,
                        res, resPoints.get(4)),
                new DisplayStep("Ustaw zakres 20 MOhm"),
                new InputStep("Ustaw na kalibratorze rezytancję: 19MOhm" + repeatingInstruction,
                        res, resPoints.get(5)),
