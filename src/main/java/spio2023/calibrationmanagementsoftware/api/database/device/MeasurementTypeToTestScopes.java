...
public class MeasurementTypeToTestScopes extends BaseEntity {
    ...
    public MeasurementTypeToTestScopes(Map.Entry<spio2023.calibrationmanagementsoftware.api.model.unit.MeasurementType, List<spio2023.calibrationmanagementsoftware.api.model.device.TestScope>> model) {
