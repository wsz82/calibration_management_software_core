...
public class MeasurementTypeToControlPoints extends BaseEntity {
    ...
    public MeasurementTypeToControlPoints(Map.Entry<spio2023.calibrationmanagementsoftware.api.model.unit.MeasurementType, List<spio2023.calibrationmanagementsoftware.api.model.unit.ControlPoint>> entry) {
